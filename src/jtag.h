...
#define JTAG_GOWIN_STATUS_AUTO_BOOT_2ND_FAIL (1 << 4) // GW2AR 0
...
#define JTAG_GOWIN_STATUS_AUTO_BOOT_1ST_FAILED (1 << 9) // GW2AR 0
#define JTAG_GOWIN_STATUS_NON_JTAG_CNF_ACTIVE (1 << 10)
#define JTAG_GOWIN_STATUS_BYPASS (1 << 11)
#define JTAG_GOWIN_STATUS_I2C_SRAM_F (1 << 12) // AST138 AT60K, GW2AR 0
#define JTAG_GOWIN_STATUS_DONE_FINAL (1 << 13)
#define JTAG_GOWIN_STATUS_SECURITY_FINAL (1 << 14)
#define JTAG_GOWIN_STATUS_ENCRYPTED_FORMAT (1 << 15) // AST138 AT60K
#define JTAG_GOWIN_STATUS_KEY_IS_RIGHT (1 << 16) // AST138 AT60K
#define JTAG_GOWIN_STATUS_SSPI_MODE (1 << 17) // AST138 AT60K, GW2AR 0
#define JTAG_GOWIN_STATUS_SER_CRC_DONE (1 << 18) // GW2AR 0
...
#define JTAG_GOWIN_STATUS_CPU_BUS_WIDTH_0 (1 << 23)
#define JTAG_GOWIN_STATUS_CPU_BUS_WIDTH_1 (1 << 24)
#define JTAG_GOWIN_STATUS_SYNC_DET_TERY_0 (1 << 25) /* AT60K A25 */
#define JTAG_GOWIN_STATUS_SYNC_DET_TERY_1 (1 << 26) /* AT60K A25 */
#define JTAG_GOWIN_STATUS_DECOMP_FAIL (1 << 27) // AT60K A25
#define JTAG_GOWIN_STATUS_MFG_DONE (1 << 28) // AT60K A25
#define JTAG_GOWIN_STATUS_INIT (1 << 29) // AT60K A25
#define JTAG_GOWIN_STATUS_WAKEUP (1 << 30) // AT60K A25
#define JTAG_GOWIN_STATUS_AUTO_ERASE (1 << 31) // AT60K A25
